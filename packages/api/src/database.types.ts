...
export type Functions<DefaultSchemaFunctionNameOrOptions extends keyof DefaultSchema['Functions']> =
  DefaultSchema['Functions'][DefaultSchemaFunctionNameOrOptions];
